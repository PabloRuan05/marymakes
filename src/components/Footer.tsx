    ...
    <footer className="border-t border-border bg-secondary/30 mt-16">
      <div className="container px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Seu destino principal para produtos de maquiagem e beleza de alta
              qualidade. Descubra as últimas tendências e clássicos atemporais.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Mary Makes. Todos os direitos
            reservados.
          </p>
        </div>
      </div>
